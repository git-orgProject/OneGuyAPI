...
=======
    ...
    picture_url = models.CharField(max_length=200,
                                   ...
                                   blank=True,
                                   null=True)
>>>>>>> ceaec6a385109bdc3673b17a42e2a1c209731470
...
class Commodity(models.Model):  # 要继承
    ...
    categoryId = models.ForeignKey(CategoryEntity, on_delete="SET_NULL", blank=True, null=True, verbose_name="分类id")
    ...
    canNoReasonToReturnText = models.CharField(max_length="100", default="不支持7天无理由退货")
    deliveryTips = models.CharField(max_length="100", default=" 16:00 前完成订单，预计明日送达")
